...
export class HttpService {
  ...
  fetchWeather(zip) {
    return this._http.get("http://api.openweathermap.org/data/2.5/weather?zip="+zip+",us&APPID=71808975185a1d637ac5e5f7ee4a9f4b").map(response=>response.json()).toPromise()
  }
